...
var auth_schema_1 = __importDefault(require("../schema/auth.schema"));
...
var AuthController = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.AuthService.registerUser(email, password)];
                    case 1:
        ...
        this.verify = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.AuthService.verifyUser(req.user)];
                    case 1:
                        user = _a.sent();
                        res.json({ user: user });
                        return [3 /*break*/, 3];
    ...
    AuthController.prototype.initialiseRoutes = function () {
        this.router.post("".concat(this.path, "/register"), (0, validation_middleware_1.default)(auth_schema_1.default.Auth), this.register);
        this.router.post("".concat(this.path, "/login"), (0, validation_middleware_1.default)(auth_schema_1.default.Auth), this.login);
        this.router.get("".concat(this.path, "/verify"), jwt_middleware_1.isAuth, this.verify);
    };
