...
var equipment_schema_1 = __importDefault(require("../schema/equipment.schema"));
var equipment_service_1 = __importDefault(require("../service/equipment.service"));
...
var EquipmentController = /** @class */ (function () {
    function EquipmentController() {
        ...
        this.getAllEquipments = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var equipments, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.EquipmentService.getAllEquipments()];
                    case 1:
                        equipments = _a.sent();
        ...
        this.getEquipmentById = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var id, Equipment, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, this.EquipmentService.getEquipmentById(id)];
                    case 1:
                        Equipment = _a.sent();
                        if (Equipment) {
        ...
        this.deleteEquipmentById = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var id, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, this.EquipmentService.deleteEquipmentById(id)];
                    case 1:
                        result = _a.sent();
                        if (result) {
    ...
    EquipmentController.prototype.initialiseRoutes = function () {
        this.router.post("".concat(this.path), (0, validation_middleware_1.default)(equipment_schema_1.default.createEquipment), this.createEquipment);
        this.router.get("".concat(this.path), this.getAllEquipments);
        this.router.post("".concat(this.path, "/images"), upload.array('images'), this.uploadImages);
        this.router.get("".concat(this.path, "/:id"), this.getEquipmentById);
        this.router.delete("".concat(this.path, "/:id"), this.deleteEquipmentById);
    };
