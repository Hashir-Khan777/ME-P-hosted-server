...
var StoreController = /** @class */ (function () {
    function StoreController() {
        ...
        this.addStore = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var user, _a, country, state, area, postalCode, address, name_1, store, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        user = req.user;
                        _a = req.body, country = _a.country, state = _a.state, area = _a.area, postalCode = _a.postalCode, address = _a.address, name_1 = _a.name;
                        return [4 /*yield*/, this.StoreService.createStore(user === null || user === void 0 ? void 0 : user._id, country, state, area, postalCode, address, name_1)];
                    case 1:
                        store = _b.sent();
